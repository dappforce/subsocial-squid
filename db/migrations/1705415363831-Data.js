module.exports = class Data1705415363831 {
    name = 'Data1705415363831'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "evm_substrate_account_link" ("id" character varying NOT NULL, "active" boolean NOT NULL, "created_at_block" numeric, "created_at_time" TIMESTAMP WITH TIME ZONE, "evm_account_id" character varying, "substrate_account_id" character varying, CONSTRAINT "PK_92db763d52ebce23e65fde074c6" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_10d44a622e54f54357ad6bc4e2" ON "evm_substrate_account_link" ("evm_account_id") `)
        ...
        await db.query(`CREATE INDEX "IDX_f0d10fa7a01ed5506cce5c0c12" ON "post" ("in_reply_to_post_id") `)
        ...
        await db.query(`CREATE INDEX "IDX_881d5e72a5f5455223334d2a7e" ON "activity" ("extension_id") `)
        ...
        await db.query(`ALTER TABLE "post" ADD CONSTRAINT "FK_f0d10fa7a01ed5506cce5c0c123" FOREIGN KEY ("in_reply_to_post_id") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "evm_substrate_account_link"`)
        await db.query(`DROP INDEX "public"."IDX_10d44a622e54f54357ad6bc4e2"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_0533ceb0b45154c95b6acf4ca7"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_f0d10fa7a01ed5506cce5c0c12"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_881d5e72a5f5455223334d2a7e"`)
        ...
        await db.query(`ALTER TABLE "post" DROP CONSTRAINT "FK_f0d10fa7a01ed5506cce5c0c123"`)
