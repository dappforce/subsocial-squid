module.exports = class Data1675710521116 {
    name = 'Data1675710521116'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "followers_count" integer NOT NULL, "following_accounts_count" integer NOT NULL, "owned_posts_count" integer NOT NULL, "following_posts_count" integer NOT NULL, "following_spaces_count" integer NOT NULL, "updated_at_time" TIMESTAMP WITH TIME ZONE, "updated_at_block" numeric, "profile_space_id" character varying, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
