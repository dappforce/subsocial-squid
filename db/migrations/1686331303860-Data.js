module.exports = class Data1686331303860 {
    name = 'Data1686331303860'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "content_extension" ("id" character varying NOT NULL, "extension_schema_id" character varying(19) NOT NULL, "chain" text, "token" text, "amount" numeric, "decimals" integer, "tx_hash" text, "collection_id" text, "nft_id" text, "url" text, "parent_post_id" character varying, "created_by_id" character varying, "from_substrate_id" character varying, "from_evm_id" character varying, "to_substrate_id" character varying, "to_evm_id" character varying, CONSTRAINT "PK_99dfae896235e3cbcbbd53d4333" PRIMARY KEY ("id"))`)
