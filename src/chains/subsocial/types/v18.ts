...
export type ProxyType = ProxyType_Any | ProxyType_DomainRegistrar | ProxyType_Management | ProxyType_SocialActions
...
export const ProfilesCall: sts.Type<ProfilesCall> = sts.closedEnum(() => {
    return  {
        force_set_space_as_profile: sts.enumStruct({
            account: AccountId32,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ProfilesCall = ProfilesCall_force_set_space_as_profile | ProfilesCall_reset_profile | ProfilesCall_set_profile
...
export const DomainsCall: sts.Type<DomainsCall> = sts.closedEnum(() => {
    return  {
        force_register_domain: sts.enumStruct({
            target: MultiAddress,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DomainsCall = DomainsCall_force_register_domain | DomainsCall_force_set_inner_value | DomainsCall_register_domain | DomainsCall_reserve_words | DomainsCall_set_domain_content | DomainsCall_set_inner_value | DomainsCall_set_outer_value | DomainsCall_support_tlds
...
export type Call = Call_AccountFollows | Call_Authorship | Call_Balances | Call_CollatorSelection | Call_DmpQueue | Call_Domains | Call_Energy | Call_ParachainSystem | Call_PolkadotXcm | Call_Posts | Call_Profiles | Call_Proxy | Call_Reactions | Call_Roles | Call_Session | Call_SpaceFollows | Call_SpaceOwnership | Call_Spaces | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting | Call_XcmpQueue
