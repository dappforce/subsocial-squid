 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const PostFollowsCall: sts.Type<PostFollowsCall> = sts.closedEnum(() => {
    return  {
        follow_post: sts.enumStruct({
            postId: sts.bigint(),
        }),
        unfollow_post: sts.enumStruct({
            postId: sts.bigint(),
        }),
    }
})
...
export const Type_270: sts.Type<Type_270> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_273),
        V3: sts.array(() => Type_277),
    }
})
...
export const Type_277: sts.Type<Type_277> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_277),
        SetErrorHandler: sts.array(() => Type_277),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_277 = Type_277_AliasOrigin | Type_277_BurnAsset | Type_277_BuyExecution | Type_277_ClaimAsset | Type_277_ClearError | Type_277_ClearOrigin | Type_277_ClearTopic | Type_277_ClearTransactStatus | Type_277_DepositAsset | Type_277_DepositReserveAsset | Type_277_DescendOrigin | Type_277_ExchangeAsset | Type_277_ExpectAsset | Type_277_ExpectError | Type_277_ExpectOrigin | Type_277_ExpectPallet | Type_277_ExpectTransactStatus | Type_277_ExportMessage | Type_277_HrmpChannelAccepted | Type_277_HrmpChannelClosing | Type_277_HrmpNewChannelOpenRequest | Type_277_InitiateReserveWithdraw | Type_277_InitiateTeleport | Type_277_LockAsset | Type_277_NoteUnlockable | Type_277_QueryPallet | Type_277_QueryResponse | Type_277_ReceiveTeleportedAsset | Type_277_RefundSurplus | Type_277_ReportError | Type_277_ReportHolding | Type_277_ReportTransactStatus | Type_277_RequestUnlock | Type_277_ReserveAssetDeposited | Type_277_SetAppendix | Type_277_SetErrorHandler | Type_277_SetFeesMode | Type_277_SetTopic | Type_277_SubscribeVersion | Type_277_Transact | Type_277_TransferAsset | Type_277_TransferReserveAsset | Type_277_Trap | Type_277_UniversalOrigin | Type_277_UnlockAsset | Type_277_UnpaidExecution | Type_277_UnsubscribeVersion | Type_277_WithdrawAsset

export interface Type_277_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_277_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_277_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_277_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_277_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_277_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_277_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_277_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_277_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_277_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_277_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_277_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_277_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_277_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_277_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_277_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_277_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_277_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_277_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_277_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_277_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_273 = Type_273_BuyExecution | Type_273_ClaimAsset | Type_273_ClearError | Type_273_ClearOrigin | Type_273_DepositAsset | Type_273_DepositReserveAsset | Type_273_DescendOrigin | Type_273_ExchangeAsset | Type_273_HrmpChannelAccepted | Type_273_HrmpChannelClosing | Type_273_HrmpNewChannelOpenRequest | Type_273_InitiateReserveWithdraw | Type_273_InitiateTeleport | Type_273_QueryHolding | Type_273_QueryResponse | Type_273_ReceiveTeleportedAsset | Type_273_RefundSurplus | Type_273_ReportError | Type_273_ReserveAssetDeposited | Type_273_SetAppendix | Type_273_SetErrorHandler | Type_273_SubscribeVersion | Type_273_Transact | Type_273_TransferAsset | Type_273_TransferReserveAsset | Type_273_Trap | Type_273_UnsubscribeVersion | Type_273_WithdrawAsset
...
export type Type_270 = Type_270_V2 | Type_270_V3
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const OwnershipCall: sts.Type<OwnershipCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OwnershipCall = OwnershipCall_accept_pending_ownership | OwnershipCall_reject_pending_ownership | OwnershipCall_transfer_ownership

export interface OwnershipCall_accept_pending_ownership {
    __kind: 'accept_pending_ownership'
    entity: OwnableEntity
}

export interface OwnershipCall_reject_pending_ownership {
    __kind: 'reject_pending_ownership'
    entity: OwnableEntity
}

export interface OwnershipCall_transfer_ownership {
    __kind: 'transfer_ownership'
    entity: OwnableEntity
    newOwner: AccountId32
}

export type OwnableEntity = OwnableEntity_Domain | OwnableEntity_Post | OwnableEntity_Space

export interface OwnableEntity_Domain {
    __kind: 'Domain'
    value: Bytes
}

export interface OwnableEntity_Post {
    __kind: 'Post'
    value: bigint
}

export interface OwnableEntity_Space {
    __kind: 'Space'
    value: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const FreeProxyCall: sts.Type<FreeProxyCall> = sts.closedEnum(() => {
    return  {
        add_free_proxy: sts.enumStruct({
            delegate: MultiAddress,
            proxyType: ProxyType,
            delay: sts.number(),
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const EvmAddressesCall: sts.Type<EvmAddressesCall> = sts.closedEnum(() => {
    return  {
        link_evm_address: sts.enumStruct({
            evmAddress: H160,
            evmSignature: sts.bytes(),
        }),
        unlink_evm_address: sts.enumStruct({
            evmAddress: H160,
        }),
    }
})
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EvmAddressesCall = EvmAddressesCall_link_evm_address | EvmAddressesCall_unlink_evm_address

/**
 * Link Substrate address to EVM address.
 */
export interface EvmAddressesCall_link_evm_address {
 ...
 */
export interface EvmAddressesCall_unlink_evm_address {
    __kind: 'unlink_evm_address'
    evmAddress: H160
}
...
export const DomainsCall: sts.Type<DomainsCall> = sts.closedEnum(() => {
    return  {
        force_set_inner_value: sts.enumStruct({
            domain: sts.bytes(),
            valueOpt: sts.option(() => InnerValue),
        }),
        register_domain: sts.enumStruct({
            altRecipient: sts.option(() => MultiAddress),
            fullDomain: sts.bytes(),
            content: Content,
            expiresIn: sts.number(),
        }),
        reserve_words: sts.enumStruct({
            words: sts.array(() => sts.bytes()),
        }),
        set_domain_content: sts.enumStruct({
            domain: sts.bytes(),
            newContent: Content,
        }),
        set_inner_value: sts.enumStruct({
            domain: sts.bytes(),
            valueOpt: sts.option(() => InnerValue),
        }),
        set_outer_value: sts.enumStruct({
            domain: sts.bytes(),
            valueOpt: sts.option(() => sts.bytes()),
        }),
        set_payment_beneficiary: sts.enumStruct({
            paymentBeneficiary: AccountId32,
        }),
        set_prices_config: sts.enumStruct({
            newPricesConfig: sts.array(() => sts.tuple(() => [sts.number(), sts.bigint()])),
        }),
        support_tlds: sts.enumStruct({
            tlds: sts.array(() => sts.bytes()),
        }),
    }
})
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DomainsCall = DomainsCall_force_set_inner_value | DomainsCall_register_domain | DomainsCall_reserve_words | DomainsCall_set_domain_content | DomainsCall_set_inner_value | DomainsCall_set_outer_value | DomainsCall_set_payment_beneficiary | DomainsCall_set_prices_config | DomainsCall_support_tlds
...
export interface DomainsCall_register_domain {
    ...
    altRecipient?: (MultiAddress | undefined)
    fullDomain: Bytes
    content: Content
    expiresIn: number
}
...
export interface DomainsCall_set_outer_value {
    ...
    domain: Bytes
    valueOpt?: (Bytes | undefined)
}

export interface DomainsCall_set_payment_beneficiary {
    __kind: 'set_payment_beneficiary'
    paymentBeneficiary: AccountId32
}

export interface DomainsCall_set_prices_config {
    __kind: 'set_prices_config'
    newPricesConfig: [number, bigint][]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const CreatorStakingCall: sts.Type<CreatorStakingCall> = sts.closedEnum(() => {
    return  {
        claim_backer_reward: sts.enumStruct({
            creatorId: sts.bigint(),
            restake: sts.boolean(),
        }),
        claim_creator_reward: sts.enumStruct({
            creatorId: sts.bigint(),
            era: sts.number(),
        }),
        force_new_era: sts.unit(),
        force_register_creator: sts.enumStruct({
            spaceId: sts.bigint(),
        }),
        force_unregister_creator: sts.enumStruct({
            creatorId: sts.bigint(),
        }),
        move_stake: sts.enumStruct({
            fromCreatorId: sts.bigint(),
            toCreatorId: sts.bigint(),
            amount: sts.bigint(),
        }),
        set_maintenance_mode: sts.enumStruct({
            enableMaintenance: sts.boolean(),
        }),
        set_per_block_reward: sts.enumStruct({
            newReward: sts.bigint(),
        }),
        set_reward_distribution_config: sts.enumStruct({
            newConfig: RewardDistributionConfig,
        }),
        stake: sts.enumStruct({
            creatorId: sts.bigint(),
            desiredAmount: sts.bigint(),
        }),
        unregister_creator: sts.enumStruct({
            creatorId: sts.bigint(),
        }),
        ...
        withdraw_from_inactive_creator: sts.enumStruct({
            creatorId: sts.bigint(),
        }),
...
export const RewardDistributionConfig: sts.Type<RewardDistributionConfig> = sts.struct(() => {
    return  {
        backersPercent: sts.number(),
        creatorsPercent: sts.number(),
        treasuryPercent: sts.number(),
    }
})

export interface RewardDistributionConfig {
    backersPercent: number
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CreatorStakingCall = CreatorStakingCall_claim_backer_reward | CreatorStakingCall_claim_creator_reward | CreatorStakingCall_force_new_era | CreatorStakingCall_force_register_creator | CreatorStakingCall_force_unregister_creator | CreatorStakingCall_move_stake | CreatorStakingCall_set_maintenance_mode | CreatorStakingCall_set_per_block_reward | CreatorStakingCall_set_reward_distribution_config | CreatorStakingCall_stake | CreatorStakingCall_unregister_creator | CreatorStakingCall_unstake | CreatorStakingCall_withdraw_from_inactive_creator | CreatorStakingCall_withdraw_unstaked

export interface CreatorStakingCall_claim_backer_reward {
    __kind: 'claim_backer_reward'
    creatorId: bigint
    restake: boolean
}

export interface CreatorStakingCall_claim_creator_reward {
    __kind: 'claim_creator_reward'
    creatorId: bigint
    era: number
}

export interface CreatorStakingCall_force_new_era {
    __kind: 'force_new_era'
}

export interface CreatorStakingCall_force_register_creator {
    __kind: 'force_register_creator'
    spaceId: bigint
}

export interface CreatorStakingCall_force_unregister_creator {
    __kind: 'force_unregister_creator'
    creatorId: bigint
}
 ...
 * 
 */
export interface CreatorStakingCall_move_stake {
    __kind: 'move_stake'
    fromCreatorId: bigint
    toCreatorId: bigint
    amount: bigint
}

export interface CreatorStakingCall_set_maintenance_mode {
    __kind: 'set_maintenance_mode'
    enableMaintenance: boolean
}

export interface CreatorStakingCall_set_per_block_reward {
    __kind: 'set_per_block_reward'
    newReward: bigint
}

export interface CreatorStakingCall_set_reward_distribution_config {
    __kind: 'set_reward_distribution_config'
    newConfig: RewardDistributionConfig
}

export interface CreatorStakingCall_stake {
    __kind: 'stake'
    creatorId: bigint
    desiredAmount: bigint
}

export interface CreatorStakingCall_unregister_creator {
    __kind: 'unregister_creator'
    creatorId: bigint
}
 ...
 */
export interface CreatorStakingCall_unstake {
    __kind: 'unstake'
    creatorId: bigint
    amount: bigint
}

export interface CreatorStakingCall_withdraw_from_inactive_creator {
    __kind: 'withdraw_from_inactive_creator'
    creatorId: bigint
}

export interface CreatorStakingCall_withdraw_unstaked {
...
export type Call = Call_AccountFollows | Call_Balances | Call_CollatorSelection | Call_CreatorStaking | Call_CumulusXcm | Call_DmpQueue | Call_Domains | Call_Energy | Call_EvmAddresses | Call_FreeProxy | Call_Multisig | Call_Ownership | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_PostFollows | Call_Posts | Call_Profiles | Call_Proxy | Call_Reactions | Call_ResourceDiscussions | Call_Roles | Call_Session | Call_SpaceFollows | Call_Spaces | Call_Sudo | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
...
export interface Call_CreatorStaking {
    __kind: 'CreatorStaking'
    value: CreatorStakingCall
}
...
export interface Call_EvmAddresses {
    __kind: 'EvmAddresses'
    value: EvmAddressesCall
}
...
export interface Call_Ownership {
    __kind: 'Ownership'
    value: OwnershipCall
}
...
export const OwnableEntity: sts.Type<OwnableEntity> = sts.closedEnum(() => {
    return  {
        Domain: sts.bytes(),
        Post: sts.bigint(),
        Space: sts.bigint(),
