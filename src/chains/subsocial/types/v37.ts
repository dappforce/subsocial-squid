...
export const Type_269: sts.Type<Type_269> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_272),
        V3: sts.array(() => Type_276),
    }
})
...
export type Type_276 = Type_276_AliasOrigin | Type_276_BurnAsset | Type_276_BuyExecution | Type_276_ClaimAsset | Type_276_ClearError | Type_276_ClearOrigin | Type_276_ClearTopic | Type_276_ClearTransactStatus | Type_276_DepositAsset | Type_276_DepositReserveAsset | Type_276_DescendOrigin | Type_276_ExchangeAsset | Type_276_ExpectAsset | Type_276_ExpectError | Type_276_ExpectOrigin | Type_276_ExpectPallet | Type_276_ExpectTransactStatus | Type_276_ExportMessage | Type_276_HrmpChannelAccepted | Type_276_HrmpChannelClosing | Type_276_HrmpNewChannelOpenRequest | Type_276_InitiateReserveWithdraw | Type_276_InitiateTeleport | Type_276_LockAsset | Type_276_NoteUnlockable | Type_276_QueryPallet | Type_276_QueryResponse | Type_276_ReceiveTeleportedAsset | Type_276_RefundSurplus | Type_276_ReportError | Type_276_ReportHolding | Type_276_ReportTransactStatus | Type_276_RequestUnlock | Type_276_ReserveAssetDeposited | Type_276_SetAppendix | Type_276_SetErrorHandler | Type_276_SetFeesMode | Type_276_SetTopic | Type_276_SubscribeVersion | Type_276_Transact | Type_276_TransferAsset | Type_276_TransferReserveAsset | Type_276_Trap | Type_276_UniversalOrigin | Type_276_UnlockAsset | Type_276_UnpaidExecution | Type_276_UnsubscribeVersion | Type_276_WithdrawAsset

export interface Type_276_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_276_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_276_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_276_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_276_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_276_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_276_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_276_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_276_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_276_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_276_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_276_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_276_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_276_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_276_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_276_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_276_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_276_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_276_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_276_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_276_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_272 = Type_272_BuyExecution | Type_272_ClaimAsset | Type_272_ClearError | Type_272_ClearOrigin | Type_272_DepositAsset | Type_272_DepositReserveAsset | Type_272_DescendOrigin | Type_272_ExchangeAsset | Type_272_HrmpChannelAccepted | Type_272_HrmpChannelClosing | Type_272_HrmpNewChannelOpenRequest | Type_272_InitiateReserveWithdraw | Type_272_InitiateTeleport | Type_272_QueryHolding | Type_272_QueryResponse | Type_272_ReceiveTeleportedAsset | Type_272_RefundSurplus | Type_272_ReportError | Type_272_ReserveAssetDeposited | Type_272_SetAppendix | Type_272_SetErrorHandler | Type_272_SubscribeVersion | Type_272_Transact | Type_272_TransferAsset | Type_272_TransferReserveAsset | Type_272_Trap | Type_272_UnsubscribeVersion | Type_272_WithdrawAsset
...
export type Type_269 = Type_269_V2 | Type_269_V3

export interface Type_269_V2 {
    __kind: 'V2'
    value: Type_272[]
}

export interface Type_269_V3 {
    __kind: 'V3'
    value: Type_276[]
}
...
export type Call = Call_AccountFollows | Call_Balances | Call_CollatorSelection | Call_CreatorStaking | Call_CumulusXcm | Call_DmpQueue | Call_Domains | Call_Energy | Call_EvmAddresses | Call_FreeProxy | Call_Multisig | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_PostFollows | Call_Posts | Call_Profiles | Call_Proxy | Call_Reactions | Call_ResourceDiscussions | Call_Roles | Call_Session | Call_SpaceFollows | Call_SpaceOwnership | Call_Spaces | Call_Sudo | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
