...
export type Type_250 = Type_250_Relay | Type_250_SiblingParachain

export interface Type_250_Relay {
    __kind: 'Relay'
}

export interface Type_250_SiblingParachain {
