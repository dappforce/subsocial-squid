...
export interface DomainDeposit {
...
export const DomainDeposit: sts.Type<DomainDeposit> = sts.struct(() => {
    return  {
        depositor: AccountId32,
        deposit: sts.bigint(),
    }
...
export type Call = Call_AccountFollows | Call_Authorship | Call_Balances | Call_CollatorSelection | Call_DmpQueue | Call_Domains | Call_Energy | Call_FreeProxy | Call_ParachainSystem | Call_PolkadotXcm | Call_Posts | Call_Profiles | Call_Proxy | Call_Reactions | Call_Roles | Call_Session | Call_SpaceFollows | Call_SpaceOwnership | Call_Spaces | Call_Sudo | Call_System | Call_Timestamp | Call_Utility | Call_Vesting | Call_XcmpQueue
