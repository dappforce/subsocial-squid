 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CreatorStakingCall = CreatorStakingCall_claim_backer_reward | CreatorStakingCall_claim_creator_reward | CreatorStakingCall_force_new_era | CreatorStakingCall_force_register_creator | CreatorStakingCall_force_unregister_creator | CreatorStakingCall_set_maintenance_mode | CreatorStakingCall_set_reward_distribution_config | CreatorStakingCall_stake | CreatorStakingCall_unregister_creator | CreatorStakingCall_unstake | CreatorStakingCall_withdraw_from_inactive_creator | CreatorStakingCall_withdraw_unstaked
