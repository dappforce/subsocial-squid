...
export class EvmAccountsLinkEvmAddressCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'EvmAccounts.link_evm_address')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('EvmAccounts.link_evm_address') === 'df7338c7acd9d8d1b7f769883e9ca15b10bbd0a12b9838366ae865df7e2ebe21'
    }

    /**
     * Link substrate address to EVM address.
     */
    get asV104(): {evmAddress: Uint8Array, evmSignature: Uint8Array} {
        assert(this.isV104)
        return this._chain.decodeCall(this.call)
    }
}

export class EvmAccountsUnlinkEvmAddressCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'EvmAccounts.unlink_evm_address')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('EvmAccounts.unlink_evm_address') === 'c3864f4c45559524254375abb016d744b7e859da6a10c2d7e2fe83fa01c1eade'
    }
...
export class PostFollowsFollowPostCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'PostFollows.follow_post')
        this._chain = ctx._chain
        this.call = call
    }

    get isV107(): boolean {
        return this._chain.getCallHash('PostFollows.follow_post') === 'f9262d9dba5799cc2473a7efe96fe103847ca3105b849986ffed47775c8580cb'
    }

    get asV107(): {postId: bigint} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
}

export class PostFollowsUnfollowPostCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'PostFollows.unfollow_post')
        this._chain = ctx._chain
        this.call = call
    }

    get isV107(): boolean {
        return this._chain.getCallHash('PostFollows.unfollow_post') === 'f9262d9dba5799cc2473a7efe96fe103847ca3105b849986ffed47775c8580cb'
    }
...
export class ProxyProxyCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '7c87b874c738ee1a22b1756c7769f2ee562a6b6a51c6834239d52879474e4f10'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV103(): {real: v103.MultiAddress, forceProxyType: (v103.ProxyType | undefined), call: v103.Call} {
        assert(this.isV103)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '57c7b313f63f85e012e79002ba06418bac42498a7f3f346d31f33644264718a4'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV104(): {real: v104.MultiAddress, forceProxyType: (v104.ProxyType | undefined), call: v104.Call} {
        assert(this.isV104)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '4686dcf49511c401dd3b78fe4203abcd1795201d6850a08c650d89409c84dc13'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV107(): {real: v107.MultiAddress, forceProxyType: (v107.ProxyType | undefined), call: v107.Call} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '25bf61a5c50a04cf5f9ece4272b149aa8d7c2b477914738b0e8120d60bfedaf3'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV108(): {real: v108.MultiAddress, forceProxyType: (v108.ProxyType | undefined), call: v108.Call} {
        assert(this.isV108)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyProxyAnnouncedCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === '5d3fdb64581b3c073af2f791154167facd8434ad5c3556fb4c8832b648b31eaf'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV103(): {delegate: v103.MultiAddress, real: v103.MultiAddress, forceProxyType: (v103.ProxyType | undefined), call: v103.Call} {
        assert(this.isV103)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === '9279405df94ba628164b315cf7ef173070a7e7ca97c5e85c2afdfc0bff605814'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV104(): {delegate: v104.MultiAddress, real: v104.MultiAddress, forceProxyType: (v104.ProxyType | undefined), call: v104.Call} {
        assert(this.isV104)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === 'a62b0c1f61415c29f7f371f8dcfbb7309091858ffcc660e8da775fe4b7b2f323'
    }
     ...
     * - `call`: The call to be made by the `real` account.
     */
    get asV107(): {delegate: v107.MultiAddress, real: v107.MultiAddress, forceProxyType: (v107.ProxyType | undefined), call: v107.Call} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === 'bf14e4f6d1ca2934bc7b4f54b9f04d839e4e99089e2ec384331938915842de53'
    }
...
export class ResourceDiscussionsCreateResourceDiscussionCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'ResourceDiscussions.create_resource_discussion')
        this._chain = ctx._chain
        this.call = call
    }

    get isV103(): boolean {
        return this._chain.getCallHash('ResourceDiscussions.create_resource_discussion') === 'e5583fc5c6af635017bcf7ba1b4788498e1cfa4e951dc80e5658b46ac18b2a98'
    }

    get asV103(): {resourceId: Uint8Array, spaceId: bigint, content: v103.Content} {
        assert(this.isV103)
        return this._chain.decodeCall(this.call)
    }
}

export class ResourceDiscussionsLinkPostToResourceCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'ResourceDiscussions.link_post_to_resource')
        this._chain = ctx._chain
        this.call = call
    }

    get isV103(): boolean {
        return this._chain.getCallHash('ResourceDiscussions.link_post_to_resource') === 'd103f9178cfc6d978baee5ab7b6e851a428a6653b9ecf6f0957b89afe83db79d'
    }

    get asV103(): {resourceId: Uint8Array, postId: bigint} {
        assert(this.isV103)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SudoSudoCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Sudo.sudo') === '3f8d8d72a9b3ac8678b478b4bc2c7dd4ae9b95ac016c2a99f05813e02ebcd3a5'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Sudo.sudo') === '4ed7506487cda115db04fc9eec1a312497f9102d3014bc79429586207fb4c241'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Sudo.sudo') === '6079edac3027f395da7ca221231bbe13437ed8b6c57fa8873b944a7511fd0358'
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Sudo.sudo') === '4ccd50db432b3528eeaf87ffcb7e89a8d6302d38e074546ffecd07ec719b3010'
    }
...
export class SudoSudoAsCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Sudo.sudo_as') === '91424bb1a0a4e05953dd6e015f74f815358b83a8a899b6ff93cdb93c49835fb0'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Sudo.sudo_as') === '0cb2ba5478d04e95162f546d8e001ff283cfdbb853124fcec714f1f224572a7a'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Sudo.sudo_as') === '10790a5cb96394ce78ae5556b0b23568bd9fceb08c2e97ef1481bcb047b933e1'
    }
     ...
     * # </weight>
     */
    get asV107(): {who: v107.MultiAddress, call: v107.Call} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Sudo.sudo_as') === '6121e1c187ebc4fecc8cfa06b7360d52dbe419ce6d58b4b5ceef3a1b3588ab7c'
    }
...
export class SudoSudoUncheckedWeightCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Sudo.sudo_unchecked_weight') === '7351ef2b426ae576ff3c87fdaa59fa1425270d7752287ebb05cde1cdf28d226a'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Sudo.sudo_unchecked_weight') === '52ba5ac466679ed6796a747f4ed8bdb16f4e56fb9b2236f8390406b6248dcd2e'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Sudo.sudo_unchecked_weight') === '4f4f0abda1aefb732240ffe4bd3027c29da74d44d98dddae27fb6eb36fcd7baf'
    }
     ...
     * # </weight>
     */
    get asV107(): {call: v107.Call, weight: v107.Weight} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Sudo.sudo_unchecked_weight') === 'd39a6eac3717af527f94b22178079548ba852553bcb36bd152493483a20fed1f'
    }
...
export class UtilityAsDerivativeCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === '6399ad7cd816a1fc6335e8b27d0d40afaabb4ab75ec5104884bdb35cf2fcfa32'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === 'fa5d176f8377e05469b1207ea9bb74b32b65627073e8007a78f8cbcc58f738c8'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === '2a758df74a2c7064dccaa5fe5f6c712031bbce4b5ded85c077f9cc9ffc28c425'
    }
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    get asV107(): {index: number, call: v107.Call} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === '84a3207b8f5a0ae63a04b36ba3425a0a4438df1e513c5d7e2f517c153c1a56d2'
    }
...
export class UtilityBatchCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Utility.batch') === 'f819e02eca5f2962542c9e44309590a20ce02b94ad9a01154e627ae31c5f515a'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Utility.batch') === '4195bca0dc7630687be9724da11b680f5203e0dcac35b4f2bdae9dc6c6088813'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Utility.batch') === 'b2e07e884461ea4ae04ce2d0ee4b10b0c7c5837ac1f3870be13bbef92d44dc30'
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Utility.batch') === '7dbed60d7565d47b30f7c8e3a2968ab2bf840c06c655ce4ef419c3b47a461ddc'
    }
...
export class UtilityBatchAllCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === 'f819e02eca5f2962542c9e44309590a20ce02b94ad9a01154e627ae31c5f515a'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === '4195bca0dc7630687be9724da11b680f5203e0dcac35b4f2bdae9dc6c6088813'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === 'b2e07e884461ea4ae04ce2d0ee4b10b0c7c5837ac1f3870be13bbef92d44dc30'
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === '7dbed60d7565d47b30f7c8e3a2968ab2bf840c06c655ce4ef419c3b47a461ddc'
    }
...
export class UtilityDispatchAsCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === '35c9f0bd9de26eae731ed4ab41b0d71b16d2bfe21adc62cdd339ce4a6cc4035a'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === 'd0d6fd3e69307213b4aec0c4b1ca2a3a82d758f4ce6ea60eca8be0e9dc7f2895'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === '5a04ee50478c76d91a9fcedfadffbaf14e17b01e8ed0398ead43203631162693'
    }
     ...
     * # </weight>
     */
    get asV107(): {asOrigin: v107.OriginCaller, call: v107.Call} {
        assert(this.isV107)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === '038ad8b5b2f0f73631723d05cb425d35d1aee480900c9e6483d4f29d90d3b51d'
    }
...
export class UtilityForceBatchCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Utility.force_batch') === 'f819e02eca5f2962542c9e44309590a20ce02b94ad9a01154e627ae31c5f515a'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Utility.force_batch') === '4195bca0dc7630687be9724da11b680f5203e0dcac35b4f2bdae9dc6c6088813'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Utility.force_batch') === 'b2e07e884461ea4ae04ce2d0ee4b10b0c7c5837ac1f3870be13bbef92d44dc30'
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Utility.force_batch') === '7dbed60d7565d47b30f7c8e3a2968ab2bf840c06c655ce4ef419c3b47a461ddc'
    }
...
export class UtilityWithWeightCall {
     ...
     */
    get isV103(): boolean {
        return this._chain.getCallHash('Utility.with_weight') === '7351ef2b426ae576ff3c87fdaa59fa1425270d7752287ebb05cde1cdf28d226a'
    }
     ...
     */
    get isV104(): boolean {
        return this._chain.getCallHash('Utility.with_weight') === '52ba5ac466679ed6796a747f4ed8bdb16f4e56fb9b2236f8390406b6248dcd2e'
    }
     ...
     */
    get isV107(): boolean {
        return this._chain.getCallHash('Utility.with_weight') === '4f4f0abda1aefb732240ffe4bd3027c29da74d44d98dddae27fb6eb36fcd7baf'
    }
     ...
     */
    get isV108(): boolean {
        return this._chain.getCallHash('Utility.with_weight') === 'd39a6eac3717af527f94b22178079548ba852553bcb36bd152493483a20fed1f'
    }
