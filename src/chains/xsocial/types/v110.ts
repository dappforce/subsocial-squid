 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EvmAccountsCall = EvmAccountsCall_link_evm_address | EvmAccountsCall_unlink_evm_address
 ...
 */
export interface EvmAccountsCall_unlink_evm_address {
...
export type Call = Call_AccountFollows | Call_Balances | Call_Energy | Call_EvmAccounts | Call_FreeProxy | Call_Grandpa | Call_PostFollows | Call_Posts | Call_Profiles | Call_Proxy | Call_Reactions | Call_ResourceDiscussions | Call_Roles | Call_SpaceFollows | Call_SpaceOwnership | Call_Spaces | Call_Sudo | Call_System | Call_Timestamp | Call_Utility
