...
export const Type_102: sts.Type<Type_102> = sts.struct(() => {
    return  {
...
export const EvmAccountsCall: sts.Type<EvmAccountsCall> = sts.closedEnum(() => {
    return  {
        link_eth_address: sts.enumStruct({
            ethAddress: H160,
...
export type Call = Call_AccountFollows | Call_Balances | Call_Energy | Call_EvmAccounts | Call_Grandpa | Call_Posts | Call_Profiles | Call_Proxy | Call_Reactions | Call_Roles | Call_SpaceFollows | Call_SpaceOwnership | Call_Spaces | Call_Sudo | Call_System | Call_Timestamp | Call_Utility
