...
export function getSpacePermissionsDecorated(
  permissionsSrc: v102.SpacePermissions | undefined = {
    none: undefined,
    everyone: undefined,
    follower: undefined,
  ...
  for (const permSection in permissionsSrc) {
    if (!permissionsSrc[permSection as keyof v102.SpacePermissions]) continue;
    for (const srcPermItem of permissionsSrc[
      permSection as keyof v102.SpacePermissions
    ]!) {
