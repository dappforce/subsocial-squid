 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CreatorStakingCall = CreatorStakingCall_force_register_creator | CreatorStakingCall_unregister_creator | CreatorStakingCall_force_unregister_creator | CreatorStakingCall_stake | CreatorStakingCall_unstake | CreatorStakingCall_withdraw_unstaked | CreatorStakingCall_withdraw_from_unregistered | CreatorStakingCall_claim_staker_reward | CreatorStakingCall_claim_creator_reward | CreatorStakingCall_set_maintenance_mode | CreatorStakingCall_force_new_era | CreatorStakingCall_set_reward_distribution_config
...
export interface CreatorStakingCall_claim_staker_reward {
    __kind: 'claim_staker_reward'
    spaceId: bigint
    restake: boolean
}
