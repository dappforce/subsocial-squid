...
export interface RewardsDistributionConfig {
...
export type Call = Call_System | Call_ParachainSystem | Call_Timestamp | Call_Balances | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Vesting | Call_Proxy | Call_Utility | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_Domains | Call_Energy | Call_FreeProxy | Call_CreatorStaking | Call_Roles | Call_AccountFollows | Call_Profiles | Call_SpaceFollows | Call_SpaceOwnership | Call_Spaces | Call_Posts | Call_Reactions | Call_Sudo
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DomainsCall = DomainsCall_register_domain | DomainsCall_set_inner_value | DomainsCall_force_set_inner_value | DomainsCall_set_outer_value | DomainsCall_set_domain_content | DomainsCall_reserve_words | DomainsCall_support_tlds | DomainsCall_set_payment_beneficiary | DomainsCall_set_prices_config
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CreatorStakingCall = CreatorStakingCall_force_register_creator | CreatorStakingCall_unregister_creator | CreatorStakingCall_force_unregister_creator | CreatorStakingCall_stake | CreatorStakingCall_unstake | CreatorStakingCall_withdraw_unstaked | CreatorStakingCall_withdraw_from_unregistered | CreatorStakingCall_claim_backer_reward | CreatorStakingCall_claim_creator_reward | CreatorStakingCall_set_maintenance_mode | CreatorStakingCall_force_new_era | CreatorStakingCall_set_reward_distribution_config
...
export interface CreatorStakingCall_withdraw_from_unregistered {
...
export interface CreatorStakingCall_set_reward_distribution_config {
    ...
    newConfig: RewardsDistributionConfig
}
